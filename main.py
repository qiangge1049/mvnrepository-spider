...
redis_pool = ConnectionPool(max_connections=5, host='127.0.0.1', port=6379, db=0, password='123456')

pg_pool = SimpleConnectionPool(
    3, 5, database='mvn', user='postgres', password='123456', host='127.0.0.1', port='5432'
)
